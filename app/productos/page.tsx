  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 border border-zinc-100 group flex flex-col">
      ...
      <div className="relative h-72 bg-zinc-100 overflow-hidden">
        ...
        {/* Flechas — solo visibles en hover cuando hay galería */}
        {images && (
          <>
            <button
              onClick={prev}
            ...
            {/* Miniaturas — aparecen debajo al hacer hover */}
            <div className="absolute inset-x-0 bottom-0 bg-linear-to-t from-black/60 to-transparent pt-8 pb-2 px-2 flex gap-1.5 justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
              {images.map((img, i) => (
                <button
                  key={i}
                  onClick={e => { e.stopPropagation(); setCurrent(i) }}
                  className={`relative w-10 h-10 shrink-0 rounded-lg overflow-hidden ring-2 transition-all duration-200 ${
                    i === current
                      ? 'ring-white scale-110'
                      : 'ring-white/30 hover:ring-white/70 opacity-70 hover:opacity-100'
                  }`}
                >
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-zinc-100">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-200 ${
              added ? 'bg-green-500 text-white scale-95' : 'bg-zinc-900 hover:bg-zinc-700 text-white'
            }`}
          >
            {added ? (
              <>✓ Agregado</>
...
const allProducts: Product[] = [
  {
    id: 1,
    name: 'Cuadro Campesinito al Óleo',
    price: 0,
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-campesinito-oleos.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 2,
    name: 'Cuadro Óleo Mujer',
    price: 0,
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-oleo-mujer-estilo1.png',
    gallery: [
      '/productos/cuadro-oleo-mujer-estilo1.png',
      '/productos/cuadro-oleo-mujer-estilo2.png',
    ],
    description: 'Descripción pendiente.',
  },
  {
    id: 4,
    name: 'Cuadro Óleo Copa de Cerezas',
    price: 0,
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-oleos-copa-cerezas.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 5,
    name: 'Cuadro Óleo Saxofonista',
    price: 0,
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-oleos-saxofonista.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 6,
    ...
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-virgen-guadalupe.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 7,
    ...
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-virgen.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 8,
    name: 'Retablo Floreros Tríptico al Óleo',
    price: 0,
    category: 'Retablos',
    emoji: '🖼️',
    image: '/productos/cuadro-retablo-floreros-oleos-triptico.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 9,
    name: 'Retablo Personalizable',
    price: 0,
    category: 'Retablos',
    emoji: '🖼️',
    image: '/productos/cuadro-retablo-personalizable1.png',
    gallery: [
      '/productos/cuadro-retablo-personalizable1.png',
      '/productos/cuadro-retablo-personalizable2.png',
      '/productos/retablo-personalizable-esilo3.png',
      '/productos/retablo-personalizable-estilo4.png',
      '/productos/retablos-personalizables.jpeg',
    ],
    description: 'Descripción pendiente.',
  },
  {
    id: 11,
    name: 'Retablo Jarrones',
    price: 0,
    category: 'Retablos',
    emoji: '🖼️',
    image: '/productos/retablo-jarrones.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 12,
    name: 'Retablo Madera con Frutas',
    price: 0,
    category: 'Retablos',
    emoji: '🖼️',
    image: '/productos/retablo-madera-frutas.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 13,
    name: 'Retablo Óleo Mujer Abstracta',
    price: 0,
    category: 'Retablos',
    emoji: '🖼️',
    image: '/productos/retablo-oleos-mujer-abstracta.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 14,
    name: 'Florero Estilo Rústico',
    price: 0,
    category: 'Decoración',
    emoji: '🌿',
    image: '/productos/florero-estilo-rustico.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 15,
    name: 'Alfiletero Artesanal',
    price: 0,
    category: 'Decoración',
    emoji: '🪡',
    image: '/productos/alfiletero.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 16,
    name: 'Florero Navideño',
    price: 0,
    category: 'Navidad',
    emoji: '🎄',
    image: '/productos/Florero-estilo-navideño.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 17,
    name: 'Papa Noel Decorativo',
    price: 0,
    category: 'Navidad',
    emoji: '🎅',
    image: '/productos/Papa_Noel.png',
    description: 'Descripción pendiente.',
  },
  {
    id: 18,
    name: 'Retablo Muñeco de Nieve',
    price: 0,
    category: 'Navidad',
    emoji: '⛄',
    image: '/productos/retablo-oleos-muñeco-nieve1.png',
    gallery: [
      '/productos/retablo-oleos-muñeco-nieve1.png',
      '/productos/retablo-oleos-muñeco-nieve2.png',
    ],
    description: 'Descripción pendiente.',
  },
  {
    ...
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-jesus.jpeg',
    description: 'Descripción pendiente.',
  },
  {
    id: 20,
    name: 'Cuadro El Carro',
    price: 0,
    category: 'Cuadros',
    emoji: '🎨',
    image: '/productos/cuadro-carro.jpeg',
    description: 'Descripción pendiente.',
  },
  {
    id: 21,
    ...
    category: 'Decoración',
    emoji: '🎁',
    image: '/productos/caja-decorativa.jpeg',
    gallery: [
      '/productos/caja-decorativa.jpeg',
      '/productos/caja-decorativa2.jpeg',
      '/productos/caja-decorativa3.jpeg',
    ],
    description: 'Descripción pendiente.',
  },
  {
    id: 22,
    name: 'Cuadro Papa Noel',
    price: 0,
    category: 'Navidad',
    emoji: '🎅',
    image: '/productos/cuadro-papanoel.jpeg',
    description: 'Descripción pendiente.',
  },
]
  ...
  return (
    <div className="bg-zinc-50 min-h-screen">
      ...
      <section className="bg-linear-to-r from-zinc-950 to-zinc-900 text-white py-16 text-center">
        ...
        <h1 className="text-4xl font-bold mt-3" style={{ fontFamily: 'Georgia, serif' }}>
          Nuestros Productos
        </h1>
        ...
        {activeCategory === 'Navidad' && (
          <div className="bg-linear-to-r from-red-950 to-zinc-900 rounded-2xl p-6 mb-8 text-center border border-red-900/40">
            ...
            <p className="text-zinc-400 text-sm mt-1">
              Piezas artesanales para decorar tu hogar en esta época especial
            </p>
          </div>
        )}
